...
public class questionNineController {
    ...
    public void initialize() {
        ...
        correctAnswer = "Nueve"; // Adjust this for each FXML
    }
    ...
    private void loadNextQuestion() {
        try {
            // Load the next FXML
            FXMLLoader loader = new FXMLLoader(getClass().getResource("numberTen.fxml")); // Adjust for each file
