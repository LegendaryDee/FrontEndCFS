...
public class questionSevenController {
    ...
    public void initialize() {
        ...
        correctAnswer = "Siete"; // Adjust this for each FXML
    }
    ...
    private void loadNextQuestion() {
        try {
            // Load the next FXML
            FXMLLoader loader = new FXMLLoader(getClass().getResource("numberEight.fxml")); // Adjust for each file
